    ...
    <section>
        ...
        <form method="POST" action="{{ route('checkout.customer.store') }}">
            ...
            <div class="row align-items-center">
                <label for="name_u" class="col-md-4 col-form-label">Meno</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" id="name_u" name="name_u" required>
                </div>
                <label for="surname_u" class="col-md-4 col-form-label">Priezvisko</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" id="surname_u" name="surname_u" required>
                </div>
                <label for="telephone" class="col-md-4 col-form-label">Telefónne číslo</label>
                <div class="col-md-8">
                ...
                <label for="city" class="col-md-4 col-form-label">Mesto/dedina</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" id="city" name="city" required>
                </div>
                <label for="postcode" class="col-md-4 col-form-label">PSČ</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" id="postcode" name="postcode" required maxlength="5">
                </div>
            </div>
            <div class="text-center mt-3">
                <button type="submit" class="btn btn-primary">Pokračovať na spôsob platby</button>
            </div>
        </form>
    </section>
</article>

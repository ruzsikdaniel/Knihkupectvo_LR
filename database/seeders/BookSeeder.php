    ...
    public function run(){
        $books = [
            [
                ...
                'price' => 20.23,
                'abstract' => 'Existuje ľúbostný list, ktorý by mohol zmeniť dejiny Anglicka. Tento ľúbostný list sa nachádza v pozostalosti známeho herca sira Jamesa Harrisona. Jeho odchod okrem smútiacej rodiny zanecháva aj šokujúce tajomstvo, aké by nikdy nemalo uzrieť svetlo sveta.
            ...
            [
                ...
                'author' => 'Lauren Roberts',
                'price' => 13.80,
                'abstract' => 'Paedyn Gray and Kai Azer return to the Kingdom of Ilya... And Paedyn has a life-altering choice to make. Whatever she decides will determine her fate – and the fate of those around her – forever. ​
​
            ...
            [
                ...
                'author' => 'Lauren Roberts',
                'price' => 23.80,
                'abstract' => 'With more than 60 million views on TikTok, the second heart-racing instalment in this bestselling and sizzling fantasy romance trilogy. Perfect for fans of Fourth Wing and The Hunger Games.
...
Be swept away by this bestselling, dagger-to-the-throat romantasy trilogy taking the world by storm.',
            ...
            [
                ...
                'author' => 'Lauren Roberts',
                'price' => 19.80,
                'abstract' => 'Perfect for fans of The Hunger Games and Fourth Wing. Adena and Paedyn have always been inseparable. Fate brought them together when they were young, but friendship ensured they’d always protect each other and the home they built in the slums of Loot.
...
But now Paedyn – an Ordinary – has been selected for The Purging Trials, which means almost certain death. Now alone in Loot, Adena must fend for herself. After attempting to steal, it’s a mysterious man from the market who comes to her rescue. Mak’s shadowy past and secretive power set him apart from the other low-level Elites of Loot.',
            ...
            [
                ...
                'author' => 'Holly Black',
                'price' => 16.93,
                'abstract' => 'Holly Black, jedna z najúspešnejších autoriek detskej a YA literatúry súčasnosti, odštartovala v novej trilógii príbeh o manipulácii, kráse i krutosti sveta mágie a nevyspytateľných vášňach.
...
Jude mala len sedem rokov, keď jej rodičov brutálne zavraždili a spolu s jej dvomi sestrami ju uniesli zo sveta smrteľníkov, aby žili na Najvyššom dvore vo férskej ríši obývanej prastarými, často zákernými magickými bytosťami. O desať rokov neskôr si Jude neželá nič iné než medzi nich zapadnúť. Väčšina férov však smrteľníkmi opovrhuje. Najmä princ Cardan, najmladší a najskazenejší syn Najvyššieho kráľa. Jude sa čoraz viac zapletá do dvorných intríg a klamstiev a zisťuje, že aj ona dokáže podvádzať a prelievať krv. Ale v najvyšších kruhoch dochádza k zrade a hrozí, že Kráľovský dvor pohltí násilie. Jude preto bude riskovať vlastný život v nebezpečnom spojenectve, aby zachránila svoje sestry a samotnú ríšu.',
            ...
            [
                ...
                'author' => 'Holly Black',
                'price' => 17.43,
                'abstract' => 'Nenechajte si ujsť návrat do sveta krutých férov!
...
Suren o pomoc. Jej súhlas by však ztitlenal, že mladá kráľovná bude musieť čeliť všemožným nástrahám – a hlavne chlapcovi, ktorého poznala ako dieťa, princovi, ktorému sa nedá veriť. A hrôzam, ktoré mali ostať pochované hlboko v minulosti.',
                'genre' => 'Fantasy',
                'language' => 'Slovenčina',
                'pages' => 320,
                'publisher' => 'Slovart',
            ...
            [
                ...
                'author' => 'Holly Black',
                'price' => 14.23,
                'abstract' => 'Uväznený princ. Pomstychtivá kráľovná. A vojna, ktorá rozhodne o osude celého Elfhamu.
...
Bestsellerová autorka Holly Black prináša pútavé zakončenie dilógie Ukradnutý dedič, v ktorom nepotečú len slzy, ale aj krv.',
            ...
            [
                ...
                'price' => 20.70,
                'abstract' => 'MOR, VÁLKA, HLAD, SMRT - ČTYŘI JEZDCI NA SVÝCH DĚSIVÝCH OŘÍCH SE ROZJELI PO SVĚTĚ. ČTYŘI JEZDCI NADANÍ MOCÍ ZAHUBIT VEŠKERÉ LIDSTVO. PŘIŠLI NA ZEMI. PŘIŠLI NÁS ZNIČIT.
...
Sara má pořád naději zachránit svět, možná však bude muset obětovat své srdce.',
            ...
            [
                ...
                'author' => 'Laura Thalassa',
                'price' => 19.70,
                'abstract' => 'Přišli na zemi - Mor, Válka, Hlad a Smrt - čtyři Jezdci apokalypsy, kteří se na svých hrůzostrašných ořích rozjeli po světě nadáni mocí zahubit veškeré lidstvo.
...
Když Jeruzalém padne do rukou armády nájezdníků, Miriam Elmahdyová je přesvědčená, že její život skončil. Domy hoří, ulice rudnou krví a vojáci masakrují nevinné - tohle nemůže přežít… A potom upoutá pozornost děsivého vůdce uchvatitelů, samotného Války. Jezdec se vydá Miriam pronásledovat, ale místo aby ji zabil, nazve ji svou „manželkou" a unese ji do svého tábora. Od té chvíle mladá žena z první řady sleduje konec světa, kdy město za městem lehá popelem, zatímco ten, kdo je za to zodpovědný - její nesmrtelný apokalyptický „manžel" - ji drží v zajetí. Vedle krutosti jí však Válka ukazuje i svou druhou tvář, láskavou a milující, která si ji podmaňuje, a Miriam možná nebude dost silná, aby odolala. Jestliže se však v životě něco naučila, pak to, že láska a válka nemohou existovat vedle sebe. Musí učinit zásadní volbu: vzdát se Válce a sledovat pád lidstva, nebo obětovat vše, aby ho zastavila.',
            ...
            [
                ...
                'author' => 'L.J. Andrews',
                'price' => 29.35,
                'abstract' => 'They stole his crown. So, he stole their daughter…
...
She’s innocent. He’s vicious. But he will take back what he lost, no matter the price.',
            ...
            [
                ...
                'author' => 'L.J. Andrews',
                'price' => 19.35,
                'abstract' => 'Ukradli mu korunu. On im za to ukradol dcéru... Erik, zjazvený kráľ Večného kráľovstva, už roky nemyslí na nič iné, len na pomstu mužovi, ktorý mu zabil otca, uväznil ho pod hladinou a urobil z neho väzňa vo vlastnej ríši. Až do chvíle, keď dcéra jeho nepriateľa neúmyselne pretrhne putá Večného kráľovstva a Erik z nej spraví nevedomého pešiaka vo svojej krutej pomste. Je nevinná a on zlomyseľný. Vezme si späť, čo stratil, bez ohľadu na cenu. Ak mu ona najskôr neukradne srdce.',
                'genre' => 'Fantasy',
                'language' => 'Slovenčina',
                'pages' => 474,
...
Nepriatelia ho zradili pre chamtivosť a túžbu po korune. Uniesli mu ženu, ktorá si podmanila jeho dušu. On jej však daroval svoje srdce a nikdy ju neprestane hľadať. Neprestane, kým nerozleje krv nepriateľov a nezavesí Večnej kráľovnej na krk náhrdelník z ich kostí.',
            ...
            [
                ...
                'author' => 'Ann Liang',
                'price' => 12.95,
                'abstract' => 'Sadie doesn\'t have to hold back in her email drafts because nobody will ever read them ... that is, until someone sends them out. Seventeen-year-old Sadie Wen is perfect on paper.

...
Route::get('/book_search', [BookController::class, 'book_search'])->middleware(['find'])->name('book_search');
...
Route::get('/admin/addBook', [AdminController::class, 'addBook'])->middleware(['admin'])->name('admin.addBook');

Route::get('/admin/book/{id}', [AdminController::class, 'book'])->middleware(['admin'])->name('admin.book');

Route::put('/admin/book/{id}', [AdminController::class, 'updateBook'])->middleware(['admin'])->name('admin.book.update');

Route::delete('/admin/book/{id}', [AdminController::class, 'deleteBook'])->middleware(['admin'])->name('admin.book.delete');

Route::get('/admin/book_search', [AdminController::class, 'book_search'])->middleware(['find', 'admin'])->name('admin.book.search');
